...
public class RegistrationServiceImpl {
    ...
    public String register(RegistrationRequest request) {
        ...
        String token = userAccountServiceImpl.signUpUser(
                new UserAccount(
    ...
    public String confirmToken(String token){
        ConfirmationToken confirmationToken = confirmationTokenServiceImpl.getToken1(token).orElseThrow(
        ...
        userAccountServiceImpl.enableAppUser(confirmationToken.getUserAccount().getEmailAddress());
